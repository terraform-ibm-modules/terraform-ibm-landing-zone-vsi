...
| Name | Type |
|------|------|
| [ibm_iam_authorization_policy.block_storage_kms_policy](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.76.2/docs/resources/iam_authorization_policy) | resource |
| [ibm_is_ssh_key.auto_generate_ssh_key](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.76.2/docs/resources/is_ssh_key) | resource |
| [ibm_is_ssh_key.ssh_key](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.76.2/docs/resources/is_ssh_key) | resource |
...
| [tls_private_key.auto_generate_ssh_key](https://registry.terraform.io/providers/hashicorp/tls/latest/docs/resources/private_key) | resource |
...
| <a name="input_existing_vpc_id"></a> [existing\_vpc\_id](#input\_existing\_vpc\_id) | The ID of an existing VPC. | `string` | n/a | yes |
...
| <a name="input_machine_type"></a> [machine\_type](#input\_machine\_type) | The Virtual server instance machine type. Run 'ibmcloud is instance-profiles' to get a list of regional profiles. | `string` | `"cx2-2x4"` | no |
...
| <a name="input_region"></a> [region](#input\_region) | The region to provision Virtual server instance resources in. | `string` | `"us-south"` | no |
...
| <a name="input_ssh_public_key"></a> [ssh\_public\_key](#input\_ssh\_public\_key) | A public SSH Key for Virtual server instance creation which does not already exist in the deployment region. Must be an RSA key with a key size of either 2048 bits or 4096 bits (recommended) - See https://cloud.ibm.com/docs/vpc?topic=vpc-ssh-keys. To use an existing key, enter a value for the variable 'existing\_ssh\_key\_name' instead. | `string` | `null` | no |
