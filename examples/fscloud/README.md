...
<p>
  <a href="https://cloud.ibm.com/schematics/workspaces/create?workspace_name=landing-zone-vsi-fscloud-example&repository=https://github.com/terraform-ibm-modules/terraform-ibm-landing-zone-vsi/tree/main/examples/fscloud">
...
* An IBM Cloud VSI instance with a Key Protect root key that is passed in for encrypting block storage.
...
- You need a Key Protect instance and root key available in the region that you want to deploy your VSI instance to.
