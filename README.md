...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_security_groups"></a> [security\_groups](#module\_security\_groups) | git::https://github.com/terraform-ibm-modules/terraform-ibm-security-group.git | v2.0.0 |
