...
| <a name="input_monitoring_windows_bundle_version"></a> [monitoring\_windows\_bundle\_version](#input\_monitoring\_windows\_bundle\_version) | Version of the Windows Prometheus Bundle MSI. | `string` | `"1.9.0"` | no |
