...
| <a name="input_secondary_attach_default_security_group"></a> [secondary\_attach\_default\_security\_group](#input\_secondary\_attach\_default\_security\_group) | Attach the default security group to the secondary interface | `bool` | `false` | no |
