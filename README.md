...
| <a name="input_install_sysdig_agent"></a> [install\_sysdig\_agent](#input\_install\_sysdig\_agent) | Set to true to enable installing the sysdig agent into your VSI at time of creation. | `bool` | `false` | no |
